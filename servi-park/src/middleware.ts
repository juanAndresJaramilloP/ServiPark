...
export default withAuth(
    ...
    function middleware(request: NextRequestWithAuth) {
        ...
        if((request.nextUrl.pathname.startsWith("/admin") || request.nextUrl.pathname.startsWith("/management")) && request.nextauth.token?.role !== "ADMINISTRADOR" && request.nextauth.token?.role !== "GERENTE") {
